 ...
 */
public class VehiculoVahosMontoyaKatherine2223 {
    ...
    public VehiculoVahosMontoyaKatherine2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoVahosMontoyaKatherine2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
